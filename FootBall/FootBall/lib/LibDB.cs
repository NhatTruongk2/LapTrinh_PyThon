...
namespace SuatAn
{
    public class SqlServer
    {
        ...
        public SqlServer()
        {
            ...
            SqlServer.ConnectionString = "Data Source=nhattruong\\SQLEXPRESS;Initial Catalog=testball;User ID=sa;Password = truong03122002;Encrypt=False";
        }
